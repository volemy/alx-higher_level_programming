...
class Rectangle:
    ...
    def __str__(self):
        ...
        for i in range(self.__height):
            for j in range(self.__width):
                rectangle_image += str(self.print_symbol)
            rectangle_image += "\n"
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        this finds the biggest rectangle basing on the area

        attributes:
                  rectangle_1: first rectangle itnstance
                  rectangle_2: second rectangle instance

        Returns:
               Instance with the biggest area or rectangle_1
